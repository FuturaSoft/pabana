...
class File {
	 ...
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/Folder
	 */
	 ...
	 *
	 * @var string
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File#prop._sName
	 */
	private $_sName = null;
	 ...
	 *
	 * @var resource
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File#prop._hHandle
	 */
	 ...
	 *
	 * @var bool
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File#prop._bLock
	 */
	private $_bLock = null;
	 ...
	 *
	 * @var string
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File#prop._sPath
	 */
	private $_sPath;
	 ...
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/__construct
	 */
	public function __construct($sPath, $bCreate = false, $nMode = 0755) {
		// Get folder of this file and create it if not exist
		$this->_oFolder = new Folder(dirname($sPath), $bCreate, $hMode);
		// Set path of file
		$this->_sPath = $sPath;
	 ...
	 * @return int|boolean
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/append
	 */
	public function append($sText) {
		return file_put_contents($this->_sPath, $sText, FILE_APPEND);
	}
	 ...
	 *
	 * @return bool
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/create
	 */
	 ...
	 *
	 * @return string
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/name
	 */
	public function name() {
		...
		if (empty($this->_sName)) {
			...
			if (!is_dir($this->getAbsolutePath())) {
				// Set name of file
				$this->_sName = basename($this->getAbsolutePath());
			} else {
	...
	public function absolutePath() {
		$this->_sPath = realpath($this->_sPath);
		return $this->_sPath;
	}
	 ...
	 *
	 * @return void
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/isFile
	 */
	public function isFile() {
		return is_file($this->_sPath);
	}
	 ...
	 * @return int|string
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/size
	 */
	public function size($bHumanReadable = false) {
		$nFilesize = filesize($this->_sPath);
		if ($bHumanReadable) {
	 ...
	 * @return bool
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/copy
	 */
	public function copy($sDestination, $bOverwrite = true) {
		if (!$this->exists() || (is_file($sDestination) && !$bOverwrite)) {
			return false;
		}
		return copy($this->_sPath, $sDestination);
	}
	 ...
	 * @return void
	 * @link http://pabana.co/en/documentation/1.0/Filesystem/File/clearCache
	 */
