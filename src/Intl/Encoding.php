...
class Encoding
{
     ...
     * @param   string $sInCharset Charset of $mValue before convert
     * (if value = 'auto' so charset will be detected).
     * @param   string $sOutCharset Charset of $mValue after convert
     * (if value = 'auto' so application charset will be use).
